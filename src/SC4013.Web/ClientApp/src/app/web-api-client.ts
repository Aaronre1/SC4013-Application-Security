...
export interface ITodoItemsClient {
    getTodoItems(listId: number): Observable<TodoItemDto[]>;
    createTodoItem(command: CreateTodoItemCommand): Observable<number>;
    assignTodoItem(command: AssignTodoItemCommand): Observable<void>;
    updateTodoItem(command: UpdateTodoItemCommand): Observable<void>;
    updateDueDate(command: UpdateDueDateCommand): Observable<void>;
...
export class TodoItemsClient implements ITodoItemsClient {
    ...
    assignTodoItem(command: AssignTodoItemCommand): Observable<void> {
        let url_ = this.baseUrl + "/api/TodoItems/Assign";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAssignTodoItem(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAssignTodoItem(response_ as any);
                } catch (e) {
    ...
    protected processAssignTodoItem(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    updateTodoItem(command: UpdateTodoItemCommand): Observable<void> {
        let url_ = this.baseUrl + "/api/TodoItems/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    updateDueDate(command: UpdateDueDateCommand): Observable<void> {
        let url_ = this.baseUrl + "/api/TodoItems/UpdateDueDate";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateDueDate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateDueDate(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processUpdateDueDate(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AssignTodoItemCommand implements IAssignTodoItemCommand {
    id?: number;
    assigneeEmail?: string | undefined;

    constructor(data?: IAssignTodoItemCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AssignTodoItemCommand {
        data = typeof data === 'object' ? data : {};
        let result = new AssignTodoItemCommand();
        result.init(data);
        return result;
    }
...
export interface IAssignTodoItemCommand {
    id?: number;
    assigneeEmail?: string | undefined;
}
...
export class UpdateDueDateCommand implements IUpdateDueDateCommand {
    id?: number;
    dueDate?: Date | undefined;

    constructor(data?: IUpdateDueDateCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateDueDateCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateDueDateCommand();
        result.init(data);
        return result;
    }
